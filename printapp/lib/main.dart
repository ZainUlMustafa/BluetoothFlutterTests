...
class _MyAppState extends State<MyApp> {
  ...
  Future<List<int>> getGraphicsTicket() async {
    ...
    bytes += generator.qrcode('deeprow.com');
    bytes += generator.text("DeepROW by Strada Imaging");
    ByteData imageBytes = await rootBundle.load('assets/deeprow.jpg');
    bytes += generator
        .imageRaster(imglib.decodeImage(imageBytes.buffer.asUint8List()));
    bytes += generator.hr();
    bytes += generator.text("Thank you for purchasing our DeepROW Cam.");
    bytes += generator.cut();
